...
public class OpenAiChatService : IAiChatService
{
    ...
    private const string GeneratePlanSystemPrompt =
        ...
        14. TOKEN BUDGET - CỰC KỲ QUAN TRỌNG: Toàn bộ JSON output PHẢI hoàn chỉnh và đóng ngoặc đầy đủ trong giới hạn 6000 tokens. Nếu kế hoạch lớn, hãy RÚT NGẮN Description (tối đa 1-2 câu mỗi field) thay vì để JSON bị cắt giữa chừng. TUYỆT ĐỐI không được để JSON ở trạng thái chưa đóng ngoặc.
